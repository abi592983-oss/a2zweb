...
const contacts=()=>`${data.phone?link('tel:'+data.phone,'Call A2Z'):''}${data.whatsapp?link('https://wa.me/'+data.whatsapp.replace(/\D/g,''),'WhatsApp','accent'):''}${data.email?link('mailto:'+data.email,'Email us','outline'):''}`;
...
function booking(){return intro('LET’S GET IT SORTED','Tell us what you need.','Complete the booking form. A visit is confirmed only after we contact you.')+`<div class="columns"><div class="panel"><span class="badge">SERVICE REQUEST</span><h3>Book a repair, installation or health check.</h3><p>Have your contact details, service address and device details ready.</p><a class="button" href="${safeURL(data.booking?.formUrl)}">Open booking form ↗</a><p class="note">Complete and submit your request in Google Forms.</p></div><aside class="panel"><span class="badge">BY APPOINTMENT</span><h3>One request.<br>A clear next step.</h3><p>1. Tell us about the device or installation.</p><p>2. We confirm the work, location and appointment.</p><p>3. Pay the booking deposit once arrangements are confirmed.</p><hr><p><strong>LKR ${esc(data.deposit)} booking deposit</strong><br>Do not send payment before your appointment is confirmed.</p><p class="note">Health checks cover working systems. Fault diagnosis is a separate service.</p></aside></div>`}
